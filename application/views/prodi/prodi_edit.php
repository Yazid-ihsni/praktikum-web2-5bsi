...
<head>
    ...
    <title>Edit Program Studi oleh Ahmad Yazid Ihsani - 2310020035</title>
            ...
            <form action="<?= site_url('prodi/perbarui/' . $prodi->id_prodi) ?>" method="post">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="kode_prodi" name="kode_prodi"
                        value="<?= isset($prodi->kode_prodi) ? htmlspecialchars($prodi->kode_prodi) : '' ?>" required>
                </div>
                <div class="mb-3">
                    <label for="nama_prodi" class="form-label">Nama Program Studi</label>
                    <input type="text" class="form-control" id="nama_prodi" name="nama_prodi"
                        value="<?= isset($prodi->nama_prodi) ? htmlspecialchars($prodi->nama_prodi) : '' ?>" required>
                </div>
                <div class="d-grid gap-2">
                    <button type="submit" class="btn btn-primary btn-custom">Perbarui</button>
